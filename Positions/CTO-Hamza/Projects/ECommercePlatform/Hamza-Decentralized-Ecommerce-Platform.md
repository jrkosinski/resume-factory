...
**Primary Stack:** MedusaJS, NestJS, Next.js, TypeScript, PostgreSQL, Redis, AWS EC2, AWS RDS, AWS DynamoDB, AWS S3, AWS Load Balancing, Kubernetes, RabbitMQ, Solidity integration
...
> Architected a production Web3 commerce system across Next.js, MedusaJS, NestJS, PostgreSQL, Redis, RabbitMQ, AWS Kubernetes, DynamoDB, S3, Solidity contracts, chain listeners, and LiFi-based cross-chain settlement.
...
* RabbitMQ event-driven payment processing.
...
> Built and led engineering across NestJS, TypeScript, MedusaJS, PostgreSQL, Redis, RabbitMQ, AWS Kubernetes, DynamoDB, S3, and load-balanced production infrastructure.
...
* Built and led backend engineering across NestJS, TypeScript, MedusaJS, PostgreSQL, Redis, RabbitMQ, AWS RDS, AWS DynamoDB, AWS S3, AWS load balancing, and Kubernetes.

* Architected a production Web3 commerce system spanning Next.js storefronts, MedusaJS/NestJS backends, PostgreSQL, Redis, RabbitMQ, AWS Kubernetes, DynamoDB, S3, chain listeners, LiFi settlement, and Solidity escrow contracts.
